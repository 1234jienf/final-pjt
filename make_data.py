...
first_mbti_samples = "IE"
second_mbti_samples = "SN"
third_mbti_samples = "TF"
last_mbti_samples = "PJ"
...
def random_mbti():
    result_mbti = ""
    result_mbti += random.choice(first_mbti_samples)
    result_mbti += random.choice(second_mbti_samples)
    result_mbti += random.choice(third_mbti_samples)
    result_mbti += random.choice(last_mbti_samples)
    return result_mbti
...
API_KEY = 'e4806658f5e4faa22c7cdb73b3431e10'
...
dict_keys = ['username', 'gender', 'financial_products', 'age', 'money', 'salary', 'mbti']
